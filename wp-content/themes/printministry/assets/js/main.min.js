...
!(function (e, t) {
  ...
  var k =
    ...
    (function (e) {
      ...
      try {
        D.apply((L = M.call(w.childNodes)), w.childNodes),
      ...
      function ae(e, t, i, o) {
        ...
        if (!o && (h(t), (t = t || p), v)) {
          ...
          if (
            ...
            if (((y = e), (m = t), 1 === w && (X.test(e) || B.test(e)))) {
              for (
      ...
      (ae.attr = function (e, t) {
        ...
        var o = i.attrHandle[t.toLowerCase()],
          s = o && P.call(i.attrHandle, t.toLowerCase()) ? o(e, t, !v) : void 0;
        return void 0 !== s
          ? s
          : n.attributes || !v
          ? e.getAttribute(t)
              ...
              return 1 === i && 0 === o
                ...
                : function (t, n, l) {
                    ...
                    if (g) {
                      ...
                      if (((f = [r ? g.firstChild : g.lastChild]), r && m)) {
                        for (
                          b =
                            (p =
                              (c =
                                (d =
                                  (u = (h = g)[x] || (h[x] = {}))[h.uniqueID] ||
                                  (u[h.uniqueID] = {}))[e] || [])[0] === k &&
                              c[1]) && c[2],
                            h = p && g.childNodes[p];
        ...
        return (
          ...
          ce(function (s, r, a, l) {
            var c,
              ...
              g = !e || (!s && t) ? v : ke(v, h, e, a, l),
              y = n ? (o || (s ? e : f || i) ? [] : r) : g;
            if ((n && n(g, y, a, l), i))
              for (c = ke(y, p), i(c, [], a, l), d = c.length; d--; )
                (u = c[d]) && (y[p[d]] = !(g[p[d]] = u));
            if (s) {
              if (o || e) {
                if (o) {
            ...
            } else (y = ke(y === r ? y.splice(f, y.length) : y)), o ? o(null, r, y, l) : D.apply(r, y);
          })
        );
      }
      function Te(e) {
        ...
        (r = ae.tokenize =
          function (e, t) {
            ...
            for (a = e, l = [], c = i.preFilter; a; ) {
              ...
              (o = B.exec(a)) &&
                ((n = o.shift()),
                s.push({ value: n, type: o[0].replace(F, " ") }),
                (a = a.slice(n.length))),
              i.filter))
                !(o = V[r].exec(a)) ||
                  (c[r] && !(o = c[r](o))) ||
                  ...
                  var n = t.length > 0,
                    ...
                    s = function (s, r, a, l, d) {
                      ...
                      for (
                        ...
                        n && ((u = !g && u) && y--, s && b.push(u));
                      }
                      if (((y += m), n && m !== y)) {
                        for (f = 0; (g = t[f++]); ) g(b, x, r, a);
                        if (s) {
                          if (y > 0)
                            for (; m--; ) b[m] || x[m] || (x[m] = O.call(l));
                          x = ke(x);
                        }
                        D.apply(l, x),
                          d &&
  ...
  (x.filter = function (e, t, n) {
    ...
    x.fn.extend({
      ...
      is: function (e) {
        return !!A(this, "string" == typeof e && C.test(e) ? x(e) : e || [], !1)
          .length;
      },
    });
  var P,
  ...
  ((x.fn.init = function (e, t, n) {
    ...
    if (((n = n || P), "string" == typeof e)) {
      ...
      return (
        (o = g.getElementById(i[2])) && ((this[0] = o), (this.length = 1)), this
      );
    }
    return e.nodeType
      ...
      function (e, t) {
        x.fn[e] = function (n, i) {
          ...
          return (
            ...
            this.length > 1 &&
              (_[e] || x.uniqueSort(o), O.test(e) && o.reverse()),
            this.pushStack(o)
          );
        };
      }
        ...
        var n = [
          ...
          o = {
            ...
            then: function (t, i, o) {
                    ...
                    c = function () {
                      ...
                      if (!(t < s)) {
                        ...
                        (c =
                          ...
                          f(c)
                            ? o
                              ? c.call(e, r(s, n, N, o), r(s, n, z, o))
                              : (s++,
                                c.call(
                                  e,
                                  r(s, n, N, o),
                                  r(s, n, z, o),
                                  r(s, n, N, n.notifyWith)
                                ))
                            : (i !== N && ((a = void 0), (l = [e])),
                              (o || n.resolveWith)(a, l));
                      }
              ...
              return x
                .Deferred(function (e) {
                  n[0][3].add(r(0, e, f(o) ? o : N, e.notifyWith)),
                    n[1][3].add(r(0, e, f(t) ? t : N)),
                    n[2][3].add(r(0, e, f(i) ? i : z));
                })
                .promise();
            },
            promise: function (e) {
    ...
    x.extend({
      ...
      ready: function (e) {
        (!0 === e ? --x.readyWait : x.isReady) ||
          ((x.isReady = !0),
          (!0 !== e && --x.readyWait > 0) || H.resolveWith(g, [x]));
      },
    }),
    (x.ready.then = H.then),
    ...
    x.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((o = G.get(s)), 1 === s.nodeType && !V.get(s, "hasDataAttrs"))
          ) {
            for (n = r.length; n--; )
              r[n] &&
  ...
  function ce(e, t) {
    for (var n, i, o = [], s = 0, r = e.length; s < r; s++)
      (i = e[s]).style &&
        ...
        t
          ? ("none" === n &&
              ((o[s] = V.get(i, "display") || null),
              o[s] || (i.style.display = "")),
            "" === i.style.display && se(i) && (o[s] = le(i)))
          : "none" !== n && ((o[s] = "none"), V.set(i, "display", n)));
  ...
  function be(e, t, n, i, o) {
    ...
    for (u.textContent = "", p = 0; (s = h[p++]); )
      if (i && x.inArray(s, i) > -1) o && o.push(s);
        ...
        ((c = ie(s)), (r = ge(u.appendChild(s), "script")), c && ye(r), n)
      )
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[t]) {
              if (r.length)
                ...
                (i = n(this, t)),
                this[t](),
                r !== (s = V.get(this, t)) || i ? V.set(this, t, !1) : (s = {}),
                r !== s)
              )
                return (
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            he.test(t.type) && t.click && $(t, "input") && Ce(t, "click", we),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            he.test(t.type) && t.click && $(t, "input") && Ce(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  function Me(e, t, n, i) {
    ...
    var o,
      ...
      g = t[0],
      y = f(g);
    if (y || (h > 1 && "string" == typeof g && !p.checkClone && Ee.test(g)))
      return e.each(function (o) {
        var s = e.eq(o);
        y && (t[0] = g.call(this, o, s.html())), Me(s, t, n, i);
      });
    if (
      h &&
      ...
      for (l = (a = x.map(ge(o, "script"), Le)).length; u < h; u++)
        (c = o),
          u !== v &&
            ((c = x.clone(c, !0, !0)), l && x.merge(a, ge(c, "script"))),
          n.call(e[u], c, u);
      if (l)
        for (d = a[a.length - 1].ownerDocument, x.map(a, Oe), u = 0; u < l; u++)
          (c = a[u]),
            fe.test(c.type || "") &&
              ...
              (c.src && "module" !== (c.type || "").toLowerCase()
                ...
                : m(c.textContent.replace(Ae, ""), c, d));
    }
    return e;
  }
  function Ne(e, t, n) {
    for (var i, o = t ? x.filter(t, e) : e, s = 0; null != (i = o[s]); s++)
      n || 1 !== i.nodeType || x.cleanData(ge(i)),
        i.parentNode &&
          (n && ie(i) && ye(ge(i, "script")), i.parentNode.removeChild(i));
    return e;
  }
  x.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (r = ge(a), i = 0, o = (s = ge(e)).length; i < o; i++)
          De(s[i], r[i]);
      if (t)
        if (n)
          for (s = s || ge(e), r = r || ge(a), i = 0, o = s.length; i < o; i++)
            _e(s[i], r[i]);
        else _e(e, a);
      return (
        (r = ge(a, "script")).length > 0 && ye(r, !l && ge(e, "script")), a
      );
    },
    ...
    x.each(
      ...
      function (e, t) {
        x.fn[e] = function (e) {
          for (var n, i = [], o = x(e), s = o.length - 1, a = 0; a <= s; a++)
  ...
  function Ke(e, t, n, i, o, s) {
    ...
    for (; r < 4; r += 2)
      "margin" === n && (l += x.css(e, n + te[r], !0, o)),
        i
          ? ("content" === n && (l -= x.css(e, "padding" + te[r], !0, o)),
            "margin" !== n &&
              (l -= x.css(e, "border" + te[r] + "Width", !0, o)))
          : ((l += x.css(e, "padding" + te[r], !0, o)),
            "padding" !== n
              ? (l += x.css(e, "border" + te[r] + "Width", !0, o))
              : (a += x.css(e, "border" + te[r] + "Width", !0, o)));
    return (
      !i &&
        s >= 0 &&
        (l +=
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var o,
          ...
          c = e.style;
        if (
          (l || (t = Xe(a)), (r = x.cssHooks[t] || x.cssHooks[a]), void 0 === n)
        )
  ...
  function lt(e, t, n) {
    ...
    for (
      ...
      if ((i = lt.prefilters[s].call(c, e, d, c.opts)))
        return (
          f(i.stop) &&
        ...
        if ((l = !x.isEmptyObject(t)) || !x.isEmptyObject(p))
          ...
          p))
            l ||
              ...
              v && ce([e], !0),
              h.done(function () {
                for (i in (v || ce([e]), V.remove(e, "fxshow"), p))
                  x.style(e, i, p[i]);
              })),
              (l = at(v ? g[i] : 0, i, h)),
              i in g ||
      ...
      stop: function (e, t, n) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (o in r) r[o] && r[o].stop && it.test(o) && i(r[o]);
            for (o = s.length; o--; )
              s[o].elem !== this ||
                (null != e && s[o].queue !== e) ||
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : ut.test(e.nodeName) || (ht.test(e.nodeName) && e.href)
              ? 0
              : -1;
          },
        },
  ...
  x.extend(x.event, {
    trigger: function (t, n, i, o) {
      ...
      if (
        ...
        3 !== i.nodeType &&
          8 !== i.nodeType &&
          !yt.test(m + x.event.triggered) &&
          (m.indexOf(".") > -1 &&
            ((b = m.split(".")), (m = b.shift()), b.sort()),
          (c = m.indexOf(":") < 0 && "on" + m),
          ((t = t[x.expando]
            ? t
            : new x.Event(m, "object" == typeof t && t)).isTrigger = o ? 2 : 3),
          (t.namespace = b.join(".")),
        ...
        if (!o && !h.noBubble && !v(i)) {
          for (
            l = h.delegateType || m, yt.test(l + m) || (r = r.parentNode);
            r;
            r = r.parentNode
          )
            y.push(r), (a = r);
        ...
        for (s = 0; (r = y[s++]) && !t.isPropagationStopped(); )
          (p = r),
            (t.type = s > 1 ? l : h.bindType || m),
            (u =
              (V.get(r, "events") || Object.create(null))[t.type] &&
              V.get(r, "handle")) && u.apply(r, n),
            (u = c && r[c]) &&
              u.apply &&
              U(r) &&
              ((t.result = u.apply(r, n)),
        ...
        return (
          ...
          o ||
            ...
            (c &&
              ...
              ((a = i[c]) && (i[c] = null),
              (x.event.triggered = m),
              t.isPropagationStopped() && p.addEventListener(m, mt),
              i[m](),
              t.isPropagationStopped() && p.removeEventListener(m, mt),
    ...
    x.extend({
      ...
      ajax: function (t, n) {
        ...
        var i,
          ...
          p = x.ajaxSetup({}, n),
          f = p.context || p,
          v = p.context && (f.nodeType || f.jquery) ? x(f) : x.event,
          y = x.Deferred(),
        ...
        p.hasContent
          ...
          : ((h = p.url.slice(o.length)),
            ...
            !1 === p.cache &&
              ((o = o.replace(Pt, "$1")),
              (h = (wt.test(o) ? "&" : "?") + "_=" + xt.guid++ + h)),
            (p.url = o + h)),
        p.ifModified &&
          (x.lastModified[o] &&
            T.setRequestHeader("If-Modified-Since", x.lastModified[o]),
        ...
        if (
          ...
          if (((T.readyState = 1), d && v.trigger("ajaxSend", [T, p]), c))
            return T;
          p.async &&
            p.timeout > 0 &&
        ...
        function C(t, n, r, l) {
          ...
          c ||
            ...
            u
              ? (p.ifModified &&
                  ((k = T.getResponseHeader("Last-Modified")) &&
                    (x.lastModified[o] = k),
                  (k = T.getResponseHeader("etag")) && (x.etag[o] = k)),
                204 === t || "HEAD" === p.type
                  ? (S = "nocontent")
                  : 304 === t
                  ? (S = "notmodified")
            ...
            (T.status = t),
            (T.statusText = (n || S) + ""),
            u ? y.resolveWith(f, [h, S, T]) : y.rejectWith(f, [T, S, g]),
            T.statusCode(b),
            (b = void 0),
            d && v.trigger(u ? "ajaxSuccess" : "ajaxError", [T, p, u ? h : g]),
            m.fireWith(f, [T, S]),
            d &&
    ...
    (t = 0),
      ...
      (n.prototype.lazyLoad = function () {
        ...
        if (
          ...
          for (
            var r = n - 1, a = i, l = o.$slider.find(".slick-slide"), c = 0;
  ...
  (function (e, t) {
    ...
    var w = function (e) {
      ...
      k = function e() {
        for (
          var t = !1, n = arguments.length, o = new Array(n), s = 0;
          s < n;
          s++
        )
          o[s] = arguments[s];
        ...
        for (var a = o.slice(1), l = a.length, c = 0; c < l; c++) {
          ...
          for (var u in d)
            if (d.hasOwnProperty(u)) {
              var h = d[u];
              if (t && (Array.isArray(h) || w(h))) {
                var p = Array.isArray(h) ? [] : {};
                r[u] = e(!0, r.hasOwnProperty(u) ? r[u] : p, h);
              } else r[u] = h;
            }
        }
        return r;
                  ...
                  var e = this.observables
                    .filter(function (e) {
                      ...
                      if (e.size.height !== t || e.size.width !== n)
                        return (e.size.height = t), (e.size.width = n), !0;
                    })
                    .map(function (e) {
                      return e.el;
                    });
        ...
        function e(t) {
          ...
          o(this, e),
            ...
            (this._pointerStart = function (e) {
              if (!(e.buttons > 0 && 0 !== e.button)) {
                ...
                n.currentPointers.some(function (e) {
                  ...
                  (n._triggerPointerStart(t, e) &&
                    (window.addEventListener("mousemove", n._move),
                    window.addEventListener("mouseup", n._pointerEnd)));
              }
            }),
            (this._touchStart = function (e) {
              for (
                var t = 0, i = Array.from(e.changedTouches || []);
                t < i.length;
                t++
              ) {
                var o = i[t];
                n._triggerPointerStart(new $(o), e);
              }
            }),
            (this._move = function (e) {
              var t,
                i = n.currentPointers.slice(),
                o = P(e)
              ...
              try {
                var a = function () {
                  var e = t.value,
                    i = n.currentPointers.findIndex(function (t) {
                      return t.id === e.id;
                    });
                  if (i < 0) return "continue";
                  s.push(e), (n.currentPointers[i] = e);
                };
            ...
            (this._triggerPointerEnd = function (e, t) {
              ...
              return !(
                i < 0 ||
                (n.currentPointers.splice(i, 1),
                n.startPointers.splice(i, 1),
                n._endCallback(e, t),
                0)
              );
            }),
            (this._pointerEnd = function (e) {
              (e.buttons > 0 && 0 !== e.button) ||
                (n._triggerPointerEnd(new $(e), e) &&
                  (window.removeEventListener("mousemove", n._move, {
                    passive: !1,
                  }),
                  window.removeEventListener("mouseup", n._pointerEnd, {
                    passive: !1,
                  })));
            }),
      ...
      _ = (function () {
        function e() {
          ...
          for (var n = 0, i = ["on", "once"]; n < i.length; n++)
            for (
              var s = i[n], r = 0, a = Object.entries(this.options[s] || {});
              r < a.length;
              r++
            ) {
              var l = a[r];
              this[s].apply(this, y(l));
            }
        }
        return (
          r(e, [
              ...
              value: function (e, t) {
                ...
                if ("function" == typeof n) {
                  for (
                    ...
                    s[r - 2] = arguments[r];
                  n = (i = n).call.apply(i, [this, this].concat(s));
                }
                return void 0 === n ? t : n;
              },
            },
                ...
                return (e = String(e).replace(
                  ...
                  function (e, i, o) {
                    ...
                    o
                      ...
                      : i && (s = t.option("l10n.".concat(i))),
                      s || (s = e);
                    for (var r = 0; r < n.length; r++)
                      s = s.split(n[r][0]).join(n[r][1]);
                    return s;
                  }
            ...
            },
            {
              ...
              value: function (e) {
                for (
                  ...
                  n[i - 1] = arguments[i];
                var o,
                  s = x(y(this.events[e] || []).slice());
                try {
                  for (s.s(); !(o = s.n()).done; ) {
                    var r = o.value;
                    if (r && !1 === r.call.apply(r, [this, this].concat(n)))
                      return !1;
                  }
                } catch (e) {
                  s.e(e);
                ...
                var a,
                  l = x(y(this.events["*"] || []).slice());
                try {
                  for (l.s(); !(a = l.n()).done; ) {
                    var c = a.value;
                    if (c && !1 === c.call.apply(c, [this, e, this].concat(n)))
                      return !1;
                  }
                } catch (e) {
                  l.e(e);
          ...
          var n,
            s =
              arguments.length > 1 && void 0 !== arguments[1]
                ...
                : {};
          o(this, i),
            ((n = t.call(this, k(!0, {}, D, s))).state = "init"),
            (n.$container = e);
          for (
            var r = 0, a = ["onLoad", "onWheel", "onClick"];
            r < a.length;
            r++
          ) {
            var l = a[r];
          ...
          r(i, [
            {
              ...
              value: function () {
                ...
                i ||
                  ...
                  (n = i).append.apply(n, y(e.childNodes)),
                  e.appendChild(i)),
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (
                  ((t < 0 && Math.abs(n - this.option("minScale")) < 0.01) ||
                  (t > 0 && Math.abs(n - this.option("maxScale")) < 0.01)
              ...
              value: function () {
                ...
                var t = new L(this.$container, {
                  start: function (n, i) {
                    ...
                    return (
                      !T(o) &&
                      !1 !== e.trigger("touchStart", i) &&
                      ("mousedown" === i.type && i.preventDefault(),
                      (e.state = "pointerdown"),
                      e.resetDragPosition(),
                      (e.dragPosition.midPoint = null),
                      (e.dragPosition.time = Date.now()),
                      !0)
                    );
                  },
                  move: function (n, i, o) {
                    if ("pointerdown" === e.state)
                      if (!1 !== e.trigger("touchMove", o)) {
                        if (
                          !(
                            i.length < 2 &&
                            !0 === e.option("panOnlyZoomed") &&
                            e.content.width <= e.viewport.width &&
                            e.content.height <= e.viewport.height &&
                            e.transform.scale <= e.option("baseScale")
                          ) &&
                          (!(i.length > 1) ||
                            (e.option("zoom") &&
                              !1 !== e.option("pinchToZoom")))
                        ) {
                          var s = A(n[0], n[1]),
                            r = A(i[0], i[1]),
                          ...
                          (e.dragOffset.x += a),
                            (e.dragOffset.y += l),
                            (e.dragOffset.scale *= u),
                            (e.dragOffset.time =
                              Date.now() - e.dragPosition.time);
                          var h =
                            1 === e.dragStart.scale && e.option("lockAxis");
                          if (h && !e.lockAxis) {
                            if (
                              Math.abs(e.dragOffset.x) < 6 &&
                              Math.abs(e.dragOffset.y) < 6
                            )
                              return void o.preventDefault();
                            var p = Math.abs(
                              (180 *
                                Math.atan2(e.dragOffset.y, e.dragOffset.x)) /
                                Math.PI
                            );
                          ...
                          if ("xy" === h || "y" !== e.lockAxis) {
                            if (
                              ...
                              (e.transform.scale === e.option("baseScale") &&
                                "y" === e.lockAxis) ||
                                (e.dragPosition.x =
                                  e.dragStart.x + e.dragOffset.x),
                              (e.transform.scale === e.option("baseScale") &&
                                "x" === e.lockAxis) ||
                                (e.dragPosition.y =
                                  e.dragStart.y + e.dragOffset.y),
                              (e.dragPosition.scale =
                                e.dragStart.scale * e.dragOffset.scale),
                              i.length > 1)
                            ) {
                              var f = A(t.startPointers[0], t.startPointers[1]),
                                v = f.clientX - e.dragStart.rect.x,
                                g = f.clientY - e.dragStart.rect.y,
                                y = e.getZoomDelta(
                                  e.content.scale * e.dragOffset.scale,
                                  v,
                                  g
                                ),
                                m = y.deltaX,
                    ...
                    if ("pointerdown" === e.state)
                      if (
                        ...
                        !1 !== e.trigger("touchEnd", o) && "decel" === e.state)
                      ) {
                        var s = e.option("minScale");
                        if (e.transform.scale < s)
                          e.zoomTo(s, { friction: 0.64 });
                        else {
                          var r = e.option("maxScale");
                          if (e.transform.scale - r > 0.01) {
            ...
            },
            {
              ...
              value: function () {
                var e = this;
                this.resizeObserver ||
                  ((this.resizeObserver = new C(function () {
                    e.updateTimer ||
                      (e.updateTimer = setTimeout(function () {
                        var t = e.$container.getBoundingClientRect();
                        t.width && t.height
                          ? ((Math.abs(t.width - e.container.width) > 1 ||
                              Math.abs(t.height - e.container.height) > 1) &&
                              (e.isAnimating() && e.endAnimation(!0),
                              e.updateMetrics(),
                              e.panTo({
                                x: e.content.x,
                                y: e.content.y,
            ...
            },
            {
              ...
              value: function (e) {
                ...
                var t,
                  ...
                  u =
                    ...
                    Math.max(
                      ...
                      parseFloat(
                        (t.width && t.width.baseVal && t.width.baseVal.value) ||
                          0
                      ),
                ...
                Object.assign(o.style, {
                  ...
                  l && Object.assign(s.style, { width: "", height: "" });
                var p = this.option("ratio");
                (c = u = S(u * p)), (d = h = S(h * p));
                var f = o.getBoundingClientRect(),
                  v = s.getBoundingClientRect(),
                  g = s == i ? v : i.getBoundingClientRect(),
                  y = Math.max(s.offsetWidth, S(v.width)),
                  m = Math.max(s.offsetHeight, S(v.height)),
                  b = window.getComputedStyle(s);
                if (
                  ((y -=
                    parseFloat(b.paddingLeft) + parseFloat(b.paddingRight)),
                  (m -= parseFloat(b.paddingTop) + parseFloat(b.paddingBottom)),
                  (this.viewport.width = y),
                  (this.viewport.height = m),
                  a)
                ) {
                  if (
                    Math.abs(u - f.width) > 0.1 ||
                    Math.abs(h - f.height) > 0.1
                  ) {
                    var x = (function (e, t, n, i) {
                      var o = Math.min(n / e || 0, i / t);
                      return { width: e * o || 0, height: t * o || 0 };
                    })(u, h, Math.min(u, f.width), Math.min(h, f.height));
                    (c = S(x.width)), (d = S(x.height));
                  }
                  Object.assign(o.style, {
                    width: "".concat(c, "px"),
                    height: "".concat(d, "px"),
            ...
            },
            {
              ...
              value: function () {
                ...
                null === i && (i = this.content.width * r * 0.5),
                  null === s && (s = this.content.height * r * 0.5);
              ...
              value: function () {
                var e =
                    arguments.length > 0 && void 0 !== arguments[0]
                      ...
                      : {},
                  t = e.x,
                  i = void 0 === t ? this.content.x : t,
                  o = e.y,
                  s = void 0 === o ? this.content.y : o,
                  r = e.scale,
                  a = e.friction,
                  l = void 0 === a ? this.option("friction") : a,
                  c = e.ignoreBounds,
                  d = void 0 !== c && c;
                if (((r = r || this.content.scale || 1), !d)) {
                  var u = this.getBounds(r),
                    h = u.boundX,
                    p = u.boundY;
                  h && (i = Math.max(Math.min(i, h.to), h.from)),
                    p && (s = Math.max(Math.min(s, p.to), p.from));
                }
                (this.friction = l),
                  (this.transform = n(
                    n({}, this.transform),
                  ...
                  l
                    ? ((this.state = "panning"),
                      (this.velocity = {
                        ...
                        scale:
                          (1 / this.friction - 1) * (r - this.content.scale),
                      }),
                      this.startAnimation())
                    : this.endAnimation();
              },
            ...
            },
            {
              ...
              value: function () {
                if ("decel" === this.state) {
                  ...
                  if (
                    (r &&
                      ((e = this.content.x < r.from),
                      (t = this.content.x > r.to)),
                    a &&
                      ((n = this.content.y < a.from),
                      (i = this.content.y > a.to)),
                    e || t)
                  ) {
                    var l = ((e ? r.from : r.to) - this.content.x) * o,
                      c =
                        this.content.x + (this.velocity.x + l) / this.friction;
                    c >= r.from && c <= r.to && (l += this.velocity.x),
                      (this.velocity.x = l),
                      this.recalculateTransform();
                  }
                  if (n || i) {
                    var d = ((n ? a.from : a.to) - this.content.y) * o,
                      u =
                        this.content.y + (d + this.velocity.y) / this.friction;
                    u >= a.from && u <= a.to && (d += this.velocity.y),
                      (this.velocity.y = d),
                      this.recalculateTransform();
                  }
                }
            ...
            },
            {
              ...
              value: function () {
                if ("pointerdown" === this.state) {
                  ...
                  if (
                    (s &&
                      ((e = this.dragPosition.x < s.from),
                      (t = this.dragPosition.x > s.to)),
                    r &&
                      ((n = this.dragPosition.y < r.from),
                      (i = this.dragPosition.y > r.to)),
                    (e || t) && (!e || !t))
                  ) {
                    var a = e ? s.from : s.to,
                      l = a - this.dragPosition.x;
                    this.dragPosition.x = a - 0.3 * l;
                  }
                  if ((n || i) && (!n || !i)) {
                    var c = n ? r.from : r.to,
            ...
            },
            {
              ...
              value: function (e) {
                var t, i, o, s, r;
                e
                  ? ((t = S(this.transform.x)),
                    (i = S(this.transform.y)),
                  ...
                  (i = S(this.content.y)),
                  e && this.option("zoom")
                    ? ((s = S(this.content.fitWidth * o)),
                      (r = S(this.content.fitHeight * o)),
                      (this.content.width = s),
                      (this.content.height = r),
                      (this.transform = n(
                        n({}, this.transform),
                        {},
                        { width: s, height: r, scale: o }
                      )),
          ...
          r(e, [
            ...
            },
            {
              ...
              value: function (e) {
                ...
                i.setAttribute(
                  "title",
                  this.carousel.localize("{{".concat(e.toUpperCase(), "}}"))
                );
                var o =
                  this.option("classNames.button") +
                  " " +
                  this.option("classNames.".concat(e));
                return (
                  (t = i.classList).add.apply(t, y(o.split(" "))),
                  i.setAttribute("tabindex", "0"),
                  (i.innerHTML = this.carousel.localize(
                    this.option("".concat(e, "Tpl"))
                  )),
                  i.addEventListener("click", function (t) {
                    t.preventDefault(),
                      t.stopPropagation(),
                      n.carousel[
                        "slide".concat("next" === e ? "Next" : "Prev")
                      ]();
                  }),
                  i
                );
            ...
            },
            {
              ...
              value: function () {
                ...
                this.$container ||
                  ...
                  (e = this.$container.classList).add.apply(
                    e,
                    y(this.option("classNames.main").split(" "))
                  ),
                    ...
                    for (
                      var r = function (t) {
                          ...
                          n.classList.add("carousel__dot"),
                            ...
                            n.setAttribute(
                              "title",
                              e.carousel.localize("{{GOTO}}", [["%d", t + 1]])
                            ),
                            n.addEventListener("keydown", function (e) {
                              ...
                              "Enter" === i || "NumpadEnter" === i
                                ...
                                : "ArrowRight" === i
                                ? (t = n.nextSibling)
                                : "ArrowLeft" === i && (t = n.previousSibling),
                                t && t.click();
                            }),
            ...
            },
            {
              ...
              value: function (e) {
                (this.selectedIndex = e),
                  y(this.nav.slides).filter(function (e) {
    ...
    var H = { Navigation: z, Dots: j, Sync: I },
      R = {
        slides: [],
        preload: 0,
        slidesPerPage: "auto",
      ...
      q = (function (e) {
        ...
        function i(e) {
          ...
          if (
            (o(this, i),
            (s = k(!0, {}, R, s)),
            ((n = t.call(this, s)).state = "init"),
            (n.$container = e),
            !(n.$container instanceof HTMLElement))
          )
            throw new Error("No root element provided");
          return (
            (n.slideNext = N(n.slideNext.bind(u(n)), 250)),
            (n.slidePrev = N(n.slidePrev.bind(u(n)), 250)),
            n.init(),
            (e.__Carousel = u(n)),
            n
          );
          ...
          r(i, [
              ...
              value: function () {
                ...
                (this.$viewport =
                  ...
                  this.$container.querySelector(
                    ".".concat(o).concat(s.viewport)
                  )),
                  this.$viewport ||
                    ((this.$viewport = document.createElement("div")),
                    (e = this.$viewport.classList).add.apply(
                      e,
                      y((o + s.viewport).split(" "))
                    ),
                    (t = this.$viewport).append.apply(
                      t,
                      y(this.$container.childNodes)
                    ),
                    this.$container.appendChild(this.$viewport)),
                  (this.$track =
                    this.option("track") ||
                    this.$container.querySelector(
                      ".".concat(o).concat(s.track)
                    )),
                  this.$track ||
                    ((this.$track = document.createElement("div")),
                    (n = this.$track.classList).add.apply(
                      n,
                      y((o + s.track).split(" "))
                    ),
                    (i = this.$track).append.apply(
                      i,
                      y(this.$viewport.childNodes)
                    ),
                ...
                (this.slides = []),
                  this.$viewport
                    ...
                    .forEach(function (t) {
                      var n = { $el: t, isDom: !0 };
                      e.slides.push(n),
                        e.trigger("createSlide", n, e.slides.length);
                    }),
                  Array.isArray(this.options.slides) &&
                    (this.slides = k(!0, y(this.slides), this.options.slides));
              },
            },
            {
              key: "updateMetrics",
              value: function () {
                ...
                if (Number.isInteger(l) && i > s)
                  ...
                  for (
                    ...
                    var p = this.slides[h];
                    (!a.length || u + p.width > s) &&
                      (a.push({ indexes: [], slides: [] }),
                      (d = a.length - 1),
                      (u = 0)),
                      (u += p.width),
                      a[d].indexes.push(h),
                ...
                a.forEach(function (e, n) {
                  (e.index = n),
                    ...
                    f && (e.left += 0.5 * (s - e.width) * -1),
                    v &&
                      !t.option("infiniteX", t.option("infinite")) &&
                      i > s &&
                      ((e.left = Math.max(e.left, 0)),
                      (e.left = Math.min(e.left, i - s)));
                });
                var g,
                  m = [];
                a.forEach(function (e) {
                  ...
                  g && t.left === g.left
                    ? ((g.width += t.width),
                      (g.slides = [].concat(y(g.slides), y(t.slides))),
                      (g.indexes = [].concat(y(g.indexes), y(t.indexes))))
                ...
                if (null === b) {
                  ...
                  (b =
                    ...
                    m[b] ||
                      (b =
                        m.length && b > m.length ? m[m.length - 1].index : 0),
                    (this.page = b),
                    (this.pageIndex = b);
                }
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.Panzoom = new M(this.$container, t)),
                  this.Panzoom.on({
                    "*": function (t) {
                      for (
            ...
            },
            {
              ...
              value: function () {
                this.Panzoom &&
                  ((this.Panzoom.content = n(
                    n({}, this.Panzoom.content),
                    {},
                    {
            ...
            },
            {
              ...
              value: function () {
                ...
                this.slides.forEach(function (l) {
                  ...
                  (c = i + t - r), (d = i + t + n + a), (c -= o * (n + r + a));
                  var p = s && l.left + l.width > c && l.left < d;
                  (c = i - t - r), (d = i - t + n + a), (c -= o * (n + r + a));
                  var f = s && l.left + l.width > c && l.left < d;
                  p || h || f
                    ? (e.createSlideEl(l),
                      h && (u = 0),
                      p && (u = -1),
                      f && (u = 1),
                      l.left + l.width > i && l.left <= i + n + a && (u = 0))
                    : e.removeSlideEl(l),
                    (l.hasDiff = u);
                });
                var l = 0,
                ...
                this.slides.forEach(function (e, n) {
                  var i = 0;
                  e.$el
                    ? (n !== l || e.hasDiff ? (i = c + e.hasDiff * t) : (c = 0),
                      (e.$el.style.left =
                        Math.abs(i) > 0.1
                          ? "".concat(c + e.hasDiff * t, "px")
                          : ""),
                      l++)
                    : (c += e.width);
                }),
                ...
                if (e) {
                  if (!e.$el) {
                    ...
                    (i.dataset.index = e.index),
                      ...
                      e.customClass &&
                        (n = i.classList).add.apply(
                          n,
                          y(e.customClass.split(" "))
                        ),
                  ...
                  (c && parseInt(c, 10) === e.index) ||
                    ...
                    (l = e.$el.dataset.lazySrc) &&
                      (e.$el.style.backgroundImage = "url('".concat(l, "')")),
                    (e.state = "ready"));
                }
              },
            },
              ...
              value: function () {
                ...
                this.slides.forEach(function (i, o) {
                  ...
                  if (s) {
                    ...
                    r && r.indexes && r.indexes.indexOf(o) > -1
                      ? (t &&
                          !s.classList.contains(t) &&
                          (s.classList.add(t), e.trigger("selectSlide", i)),
                        s.removeAttribute(n))
                      : (t &&
                          s.classList.contains(t) &&
                          (s.classList.remove(t),
                          e.trigger("unselectSlide", i)),
                        s.setAttribute(n, !0));
                  }
                });
              },
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                if (
                  ...
                  var i = g(this.getPageFromPosition(-1 * e.transform.x), 2)[1];
                  this.setPage(i);
              ...
              value: function (e, t) {
                ...
                if (
                  ...
                  var c = Math.floor(i / r) || 0,
                    d = a;
                  if (((n = this.pages[e].left + c * d), !0 === t && r > 2)) {
    ...
    var F = !(
        ...
        if (e && F) {
          ...
          try {
            if (e.setActive) e.setActive();
              ...
              e.focus(),
                document.body.scrollTo({ top: t, left: n, behavior: "auto" });
            }
          } catch (e) {}
        }
      },
      U = (function () {
        function e(t) {
          ...
          for (
            var n = 0,
              i = ["onReady", "onResize", "onTouchstart", "onTouchmove"];
            n < i.length;
            n++
          ) {
            var s = i[n];
        ...
        return (
          r(e, [
              ...
              value: function () {
                ...
                if (i) {
                  var o = "",
                    ...
                    r = "";
                  n - 1 > 0.1 &&
                    ((o = "".concat(t.width * n, "px")),
                    (s = "".concat(t.height * n, "px")),
                    (r = "translate3d("
            ...
            },
            {
              key: "onWheel",
              value: function (e) {
                T(e.composedPath()[0]) || e.preventDefault();
              },
            },
            {
              key: "cleanup",
      ...
      Y = (function () {
        function e(t) {
          o(this, e),
            ...
            (this.state = "init");
          for (
            var n = 0, i = ["onPrepare", "onClosing", "onKeydown"];
            n < i.length;
            n++
          ) {
            var s = i[n];
                ...
                if (!this.$container) {
                  ...
                  t.classList.add("fancybox__thumbs"),
                    ...
                    this.Carousel.Panzoom.on("wheel", function (t, n) {
                      n.preventDefault(),
                        e.fancybox[n.deltaY < 0 ? "prev" : "next"]();
                    }),
                    (this.$container = t),
                    (this.state = "visible");
                }
    ...
    var V = function (e, t) {
        for (
          var n = new URL(e),
            ...
            s = 0,
            r = [].concat(y(i), y(Object.entries(t)));
          s < r.length;
          s++
        ) {
          var a = g(r[s], 2),
              ...
              value: function (e) {
                ...
                if (!t || "string" == typeof t) {
                  if (
                    ...
                    var o = V(t, this.fancybox.option("Html.youtube")),
                      s = encodeURIComponent(i[1]);
                    (e.videoId = s),
                      (e.src = "https://www.youtube-nocookie.com/embed/"
                        .concat(s, "?")
                        .concat(o)),
                      (e.thumb =
                        e.thumb ||
                        "https://i.ytimg.com/vi/".concat(s, "/mqdefault.jpg")),
                      (e.vendor = "youtube"),
                      (n = "video");
                  } else if (
                    (i = t.match(/^.+vimeo.com\/(?:\/)?([\d]+)(.*)?/))
                  ) {
                    var r = V(t, this.fancybox.option("Html.vimeo")),
                      a = encodeURIComponent(i[1]);
                    (e.videoId = a),
                      (e.src = "https://player.vimeo.com/video/"
                        .concat(a, "?")
                        .concat(r)),
                      (e.vendor = "vimeo"),
                      (n = "video");
                    ...
                    (i = t.match(
                      ...
                      : (i = t.match(
                        ...
                        ((e.src = "//maps.google."
                          .concat(i[1], "/maps?q=")
                          .concat(
                            i[2].replace("query=", "q=").replace("api=1", ""),
                            "&output=embed"
                          )),
                        (n = "map"));
                  n ||
                    ("#" === t.charAt(0)
                      ...
                      : t.match(/\.(pdf)((\?|#).*)?$/i) && (n = "pdf")),
                    (e.type =
                      n || this.fancybox.option("defaultType", "image")),
                    ("html5video" !== n && "video" !== n) ||
                      ...
                      e._width && e._height
                        ? (e.ratio =
                            parseFloat(e._width) / parseFloat(e._height))
                        : (e.ratio =
                            e.ratio || e.video.ratio || G.video.ratio));
                }
              },
            },
            {
              ...
              value: function () {
                ...
                this.fancybox.Carousel.slides.forEach(function (t) {
                  t.$el &&
                    (e.setContent(t),
                    t.index === e.fancybox.getSlide().index && e.playVideo(t));
                });
              },
            },
            {
              ...
              value: function (e) {
                ...
                if (t) {
                  if ("clone" === e.type || t.$placeHolder) {
                    ...
                    (o = o
                      ? "".concat(o, "--clone")
                      : "clone-".concat(this.fancybox.id, "-").concat(e.index)),
                      t.setAttribute("id", o);
                  } else {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (
                  ...
                  i.setAttribute(
                    "id",
                    "fancybox__iframe_".concat(n.id, "_").concat(e.index)
                  ),
              ...
              value: function (e) {
                ...
                if (t) {
                  ...
                  if (n || (i && o)) {
                    ...
                    var s = t.offsetWidth,
                      r = t.offsetHeight;
                    if (((o = o || r), (i = i || s) > s || o > r)) {
                      var a = Math.min(s / i, r / o);
                      (i *= a), (o *= a);
                    }
                    Math.abs(i / o - n) > 0.01 &&
                      (n < i / o ? (i = o * n) : (o = i / n)),
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (t) {
                  ...
                  if (n || i) {
                    var h = { flex: "0 1 auto" };
                    n && (h.width = "".concat(n, "px")),
                      i && (h.height = "".concat(i, "px")),
                      Object.assign(s, h);
                  }
                }
              },
            },
            {
              ...
              value: function (e, t) {
                ...
                t.slides.forEach(function (e) {
                  e.$el &&
                    (e.$iframe && n.resizeIframe(e),
                    e.ratio && n.setAspectRatio(e));
                });
              },
            },
            {
                      ...
                      this.fancybox.setContent(
                        ...
                        this.fancybox
                          ...
                          .replace(
                            "{{format}}",
                            e.format ||
                              (e.html5video && e.html5video.format) ||
                              ""
                          )
            ...
            },
            {
              ...
              value: function (e, t, n) {
                ...
                "inline" === n.type &&
                  ...
                  n.$closeButton &&
                    (n.$closeButton.remove(), (n.$closeButton = null));
        ...
        r(e, [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              n &&
                "loading" === e.state &&
                (n.complete && n.naturalWidth && n.naturalHeight
            ...
            value: function (e) {
              ...
              e.Panzoom ||
                ...
                e.Panzoom.on("endAnimation", function () {
                  "zoomIn" === e.state && t.fancybox.done(e),
                    t.handleCursor(e),
                    t.fancybox.trigger("Image.endAnimation", e);
                }),
            ...
            value: function (e) {
              ...
              if (this.fancybox.option("Image.ignoreCoveredThumbnail")) {
                var r = document.elementFromPoint(s.left + 1, s.top + 1) === i,
                  a =
                    document.elementFromPoint(s.right - 1, s.bottom - 1) === i;
                o = r && a;
              } else
                o =
            ...
            value: function () {
              ...
              if (i) {
                (n.state = "zoomOut"),
                  ...
                  n.$caption && (n.$caption.style.visibility = "hidden");
          ...
          r(
            ...
            [
              {
                ...
                value: function (e) {
                  ...
                  if (o.slug) r = "#" + o.slug;
                    ...
                    var a = o.$trigger && o.$trigger.dataset,
                      l = e.option("slug") || (a && a.fancybox);
                    l &&
                      l.length &&
                      "true" !== l &&
                      (r =
                        "#" +
                        l +
                        (n.slides.length > 1 ? "-" + (o.index + 1) : ""));
                  }
                  i && (this.origHash = s !== r ? s : ""),
                    r &&
                      s !== r &&
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (s && s.plugins.Hash) {
                    if (n) {
                      var r = s.Carousel;
                      if (n === s.option("slug")) return r.slideTo(i - 1);
                      var a,
                        l = x(r.slides);
                      try {
                        for (l.s(); !(a = l.n()).done; ) {
              ...
              },
              {
                ...
                value: function (t) {
                  function n() {
                    window.addEventListener("hashchange", e.onHashChange, !1),
                      e.startFromUrl();
                  }
                  (e.Fancybox = t),
                    F &&
            ...
            },
            {
              ...
              value: function () {
                ...
                if (this.active && !this.timer) {
                  ...
                  this.timer = setTimeout(function () {
                    (e.timer = null),
                      e.fancybox.option("infinite") ||
                      e.fancybox.getSlide().index !==
                        e.fancybox.Carousel.slides.length - 1
                        ? e.fancybox.next()
                        : e.fancybox.jumpTo(0, { friction: 0 });
                  }, t);
                  var n = this.$progress;
                  n ||
          ...
          r(e, [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  ...
                  (this.build(),
                  this.update(),
                  (this.Slideshow = new ee(e)),
                  !e.Carousel.prevPage &&
                    (e.option("slideshow.autoStart") &&
                      this.Slideshow.activate(),
                    e.option("fullscreen.autoStart") && !Q.element()))
                )
                  try {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                e.class &&
                  (n = t.classList).add.apply(n, y(e.class.split(" "))),
                e.attr))
                  t.setAttribute(i, e.attr[i]);
                e.label &&
                  t.setAttribute(
                    "title",
                    this.fancybox.localize("{{".concat(e.label, "}}"))
                  ),
            ...
            },
            {
              ...
              value: function () {
                ...
                this.cleanup();
                var t,
                  n = this.fancybox.option("Toolbar.items"),
                  i = [
                    { position: "left", items: [] },
                  ...
                  s = x(this.fancybox.option("Toolbar.display"));
                try {
                  var r = function () {
                    var s = t.value,
                      r = void 0,
                    ...
                    if ("thumbs" === r && (!o || "disabled" === o.state))
                      return "continue";
                ...
                for (var l = 0, c = i; l < c.length; l++) {
                  ...
                  if (d.items.length) {
                    ...
                    u.classList.add("fancybox__toolbar__items"),
                      u.classList.add(
                        "fancybox__toolbar__items--".concat(d.position)
                      );
                    var h,
                      p = x(d.items);
                    try {
            ...
            },
            {
              ...
              value: function () {
                var e,
                  ...
                  o =
                    t.downloadSrc ||
                    ("image" !== t.type || t.error ? null : t.src),
                  s = x(
                ...
                try {
                  for (v.s(); !(f = v.n()).done; ) f.value.innerHTML = i;
                } catch (e) {
                  v.e(e);
                } finally {
                  v.f();
      ...
      ae = (function (e) {
        ...
        function n(e) {
          ...
          return (
            ...
            (i = t.call(this, k(!0, {}, oe, s))).bindHandlers(),
            (i.state = "init"),
            i.setItems(e),
            i.attachPlugins(n.Plugins),
            i.trigger("init"),
            !0 === i.option("hideScrollbar") && i.hideScrollbar(),
            i.initLayout(),
            i.initCarousel(),
            i.attachEvents(),
            se.set(i.id, u(i)),
            ...
            (i.state = "ready"),
            i.trigger("ready"),
            i.$container.setAttribute("aria-hidden", "false"),
            i.option("trapFocus") && i.focus(),
            i
          );
        }
        return (
            ...
            [
              {
                ...
                value: function (e) {
                  ...
                  return void 0 !== o
                    ? ("function" == typeof o &&
                        (o = (l = o).call.apply(l, [this, this].concat(r))),
                      o)
                    : (t = v(c(n.prototype), "option", this)).call.apply(
                        t,
                        [this, e].concat(r)
                      );
                },
                ...
                value: function () {
                  ...
                  t &&
                    ...
                    Object.entries({
                      ...
                      var n;
                      return (n = e.$container).setAttribute.apply(n, y(t));
                    }),
                    ...
                    this.id ||
                      ((this.id = this.options.id || ++re),
                      this.$container.setAttribute(
                        "id",
                        "fancybox-" + this.id
                      ));
                  var n,
                    i = this.option("mainClass");
                  return (
                    i &&
                      (n = this.$container.classList).add.apply(
                        n,
                        y(i.split(" "))
                      ),
                ...
                value: function (e) {
                  ...
                  try {
                    for (i.s(); !(t = i.n()).done; ) {
                      ...
                      if (s) {
                        var r = s.dataset || {};
                        (o.src = r.src || s.getAttribute("href") || o.src),
                          (o.type = r.type || o.type),
                          !o.src &&
                            s instanceof HTMLImageElement &&
                            (o.src = s.currentSrc || o.$trigger.src);
                      }
                      var a = o.$thumb;
                      if (!a) {
                      ...
                      !c &&
                        a &&
                        !(c = a.currentSrc || a.src) &&
                        a.dataset &&
                        (c = a.dataset.lazySrc || a.dataset.src),
                          ...
                          Panzoom: {
                            ...
                            panOnlyZoomed: function () {
                              return (
                                e.Carousel &&
                                e.Carousel.pages &&
                                e.Carousel.pages.length < 2 &&
                                !e.option("dragToClose")
                              );
                            },
                            lockAxis: function () {
                              if (e.Carousel) {
                ...
                value: function (e, t) {
                  ...
                  if (
                    ...
                    (i.className = "fancybox__caption"),
                      (i.innerHTML = n),
                      i.setAttribute("id", o),
                      (t.$caption = t.$el.appendChild(i)),
                      t.$el.classList.add("has-caption"),
                      t.$el.setAttribute("aria-labelledby", o);
                  }
                },
              },
              {
                ...
                value: function (e) {
                  if (!e.defaultPrevented) {
                    ...
                    if (t.matches("[data-fancybox-close]"))
                      return e.preventDefault(), void n.close(!1, e);
                    if (t.matches("[data-fancybox-next]"))
                      return e.preventDefault(), void n.next();
                    if (t.matches("[data-fancybox-prev]"))
                      return e.preventDefault(), void n.prev();
                    if (
                      !(t.matches(B) || document.activeElement.blur(),
                ...
                value: function (e) {
                  if (n.getInstance().id === this.id) {
                    ...
                    if (i && !e.ctrlKey && !e.altKey && !e.shiftKey) {
                      var o = e.composedPath()[0],
                        s =
                          document.activeElement &&
                          document.activeElement.classList,
                        r = s && s.contains("carousel__button");
                      if (
                        "Escape" !== t &&
                        !r &&
                    ...
                    if (!o || !o.contains(document.activeElement)) {
                      ...
                      for (
                        var s,
                          r = [],
                          a = 0,
                          l = Array.from(t.querySelectorAll(B));
                        a < l.length;
                        a++
                      ) {
                        var c = l[a],
                      ...
                      e
                        ...
                        ? X(s)
                        : r.indexOf(document.activeElement) < 0 && X(t),
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  if (
                    (e.filter && !e.error && (n = n.querySelector(e.filter)),
                    n instanceof Element)
                  )
                    return (
                      (e._className = "has-".concat(
              ...
              },
              {
                ...
                value: function (e, t, n) {
                  e &&
                    ...
                    e && t
                      ? (e.addEventListener("animationend", function i(o) {
              ...
              },
              {
                ...
                value: function () {
                  var e;
                  this.Carousel &&
                    (e = this.Carousel).slideTo.apply(e, arguments);
                },
              },
              {
                key: "close",
                  ...
                  if (
                    ...
                    if (
                      (this.Carousel.slides.forEach(function (e) {
                        e.$content &&
                          e.index !== n.index &&
                          t.Carousel.trigger("removeSlide", e);
                      }),
                      "closing" === this.state)
                    ) {
                      var i =
              ...
              },
              {
                ...
                value: function () {
                  if ("destroy" !== this.state) {
                    ...
                    var e = this.option("placeFocusBack")
                  ...
                  if (
                    ...
                    if (
                      ((a.matches("[data-fancybox-trigger]") ||
                        ...
                        (i = a && a.dataset && a.dataset.fancyboxTrigger),
                      i)
                    ) {
                      var l = document.querySelectorAll(
                          '[data-fancybox="'.concat(i, '"]')
                        ),
                        c = parseInt(a.dataset.fancyboxIndex, 10) || 0;
                      a = l.length ? l[c] : a;
                    }
                    a || (a = r),
                        ...
                        .some(function (t) {
                          ...
                          try {
                            s instanceof Element &&
                              ...
                              (n = s.matches(t) || (s = s.closest(t)));
                          } catch (e) {}
                          return !!n && (e.preventDefault(), (o = t), !0);
                        });
                    var d = !1;
                    if (o) {
                      (t.event = e),
              ...
              },
              {
                ...
                value: function (e) {
                  var t =
                    ...
                    i = function (e) {
                      for (
                        var t = ["false", "0", "no", "null", "undefined"],
                          n = ["true", "1", "yes"],
                        ...
                        if ("fancybox" !== l)
                          if ("width" === l || "height" === l)
                            ...
                            if (t.indexOf(c) > -1) o[l] = !1;
                            else if (n.indexOf(o[l]) > -1) o[l] = !0;
                            else
                              try {
                                o[l] = JSON.parse(c);
                              } catch (e) {
                      ...
                      return e instanceof Element && (o.$trigger = e), o;
                    },
                    o = [],
                    s = t.startIndex || 0,
                    r = t.target || null,
                    a =
                      void 0 !== (t = k({}, t, n.openers.get(e))).groupAll &&
                      t.groupAll,
                    l = void 0 === t.groupAttr ? "data-fancybox" : t.groupAttr,
                    c = l && r ? r.getAttribute("".concat(l)) : "";
                  if (!r || c || a) {
                    var d = t.root || (r ? r.getRootNode() : document.body);
                    o = [].slice.call(d.querySelectorAll(e));
                  }
                  if (
                    (r &&
                      !a &&
                  ...
                  var u = n.getInstance();
                  return (
                    !(u && o.indexOf(u.options.$trigger) > -1) &&
                    ((s = r ? o.indexOf(r) : s),
                    new n(
                      (o = o.map(i)),
                      k({}, t, { startIndex: s, $trigger: r })
                    ))
                  );
                },
              },
    ...
    (ae.version = "4.0.26"),
      ...
      (ae.openers = new Map()),
      (ae.Plugins = ie),
      ae.bind("[data-fancybox]");
    for (
      var le = 0, ce = Object.entries(ae.Plugins || {});
      le < ce.length;
      le++
    ) {
      var de = g(ce[le], 2);
      de[0];
      var ue = de[1];
      "function" == typeof ue.create && ue.create(ae);
    }
    (e.Carousel = q), (e.Fancybox = ae), (e.Panzoom = M);
  }),
  $(function () {
    window.onload;
    const e = document.querySelectorAll(".popup__link"),
    ...
    if (e.length > 0)
      for (let t = 0; t < e.length; t++) {
        ...
        n.addEventListener("click", function (e) {
          const t = n.getAttribute("href").replace("#", "");
          s(document.getElementById(t)), e.preventDefault();
        });
      }
    const o = document.querySelectorAll(".close-popup");
    if (o.length > 0)
    ...
    function s(e) {
      if (e && i) {
        const o = document.querySelector(".popup.open");
        o
          ? r(o, !1)
          : (function () {
              const e =
    ...
    document.addEventListener("keydown", function (e) {
      if ("Escape" === e.key) {
        r(document.querySelector(".popup.open"));
      }
    }),
      ...
      $(".top-slider").slick({
        ...
        cssEase: "linear",
        prevArrow:
          '<button class="slick-prev slick-arrow"><svg width="38" height="24" viewBox="0 0 38 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M38 12H2M2 12L15.5 1M2 12L15.5 23" stroke="#FFF3E5" stroke-opacity="1" stroke-width="2"/></svg></button>',
        nextArrow:
          '<button class="slick-next slick-arrow"><svg width="38" height="24" viewBox="0 0 38 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 12L36 12M36 12L22.5 23M36 12L22.5 1" stroke="#FFFAF5" stroke-width="2"/></svg></button>',
        autoplay: !0,
        speed: 1e3,
      }),
      $(".services-page__slider-inner").slick({
        prevArrow:
          '<button class="slick-prev slick-arrow"><svg width="38" height="24" viewBox="0 0 38 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M38 12H2M2 12L15.5 1M2 12L15.5 23" stroke="#FFF3E5" stroke-opacity="1" stroke-width="2"/></svg></button>',
        nextArrow:
          '<button class="slick-next slick-arrow"><svg width="38" height="24" viewBox="0 0 38 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 12L36 12M36 12L22.5 23M36 12L22.5 1" stroke="#FFFAF5" stroke-width="2"/></svg></button>',
    ...
    let l = document.querySelector(".block--active");
    null != l &&
      ((l.style.height = l.scrollHeight + "px"),
      $(".questions__items").on("click", function (e) {
        if (this.classList.contains("questions__items--active")) {
          $(".questions__items").removeClass("questions__items--active"),
            $(".questions__items").addClass("questions__items--offset"),
            $(".block").removeClass("block--active"),
            $(".block").addClass("block--ofset"),
            (this.querySelector(".block--ofset").style.height = "0");
        } else {
          $(".questions__items").removeClass("questions__items--active"),
            $(".questions__items").addClass("questions__items--offset"),
            $(this).removeClass("questions__items--offset"),
            $(this).addClass("questions__items--active"),
            $(".block").removeClass("block--active"),
            $(".block").addClass("block--ofset"),
            $(this.querySelector(".block")).removeClass("block--ofset"),
            $(this.querySelector(".block")).addClass("block--active");
          var t = $(".block--ofset");
          $.each(t, function (e, n) {
            t[e].style.height = "0";
          });
          let e = this.querySelector(".block--active");
...
function formValidate(e) {
  let error = 0;
  let path = e.srcElement;
  let formReq = path.querySelectorAll(".connection__input"); //заменить .connection__input на общий класс для input внутри всеч форм
...
function telTest(input) {
  return !/([1-9])+(?:-?\d){4,}/.test(input.value);
}
